package professor.allocation.dayvid.controller;
...
import professor.allocation.dayvid.service.DepartmentService;
...
@ResponseStatus(HttpStatus.NO_CONTENT)  
    public ResponseEntity<Void> deleteById(@PathVariable(name = "department_id")
    Long id){
